...
export default function Footer() {
  ...
  const navigationLinks = [
    ...
    {
      label: t("footer.navigation.directory"),
      href: "/direktori",
      icon: BuildingStorefrontIcon,
    },
    { label: t("footer.navigation.map"), href: "/peta", icon: MapIcon },
    {
      label: t("footer.navigation.favorites"),
      href: "/favorit",
      icon: HeartIcon,
    },
  ];
  ...
  const informationLinks = [
    ...
    {
      label: t("footer.information.contact"),
  ...
  const paymentLogos = [
    {
      src: "/assets/pembayaran/qris-logo.svg",
      alt: "QRIS",
      title: "QRIS",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/dana-logo.svg",
      alt: "DANA",
      title: "DANA",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/ovo-logo.svg",
      alt: "OVO",
      title: "OVO",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/bca-logo.svg",
      alt: "BCA",
      title: "Bank BCA",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/mandiri-logo.svg",
      alt: "Mandiri",
      title: "Bank Mandiri",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/linkaja-logo.svg",
      alt: "LinkAja",
      title: "LinkAja",
      isProminent: true,
    },
    {
      src: "/assets/pembayaran/bni-logo.svg",
      alt: "BNI",
      title: "Bank BNI",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/bri-logo.svg",
      alt: "BRI",
      title: "Bank BRI",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/bsi-logo.svg",
      alt: "BSI",
      title: "Bank Syariah Indonesia",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/bjb.svg",
      alt: "BJB",
      title: "Bank BJB",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/btn-logo-2.svg",
      alt: "BTN",
      title: "Bank BTN",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/card-logo.svg",
      alt: "Credit Card",
      title: "Credit Card",
      isProminent: false,
    },
    {
      src: "/assets/pembayaran/pospay-logo.svg",
      alt: "PosPay",
      title: "PosPay",
      isProminent: false,
    },
              ...
              {paymentLogos.map((logo, idx) => (
                <div
                  ...
                  className={`flex-shrink-0 transition-all duration-300 hover:scale-110 ${
                    logo.isProminent
                      ? "h-14 md:h-16 drop-shadow-lg hover:drop-shadow-xl"
                      : "h-10 md:h-12 opacity-70 hover:opacity-100"
                  }`}
                  title={logo.title}
                >
                  <img
                    alt={logo.alt}
                    className="h-full w-auto object-contain filter hover:brightness-110 transition-all"
                    loading="lazy"
                    src={logo.src}
                  />
                </div>
