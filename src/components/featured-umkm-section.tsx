...
export default function FeaturedUMKMSection() {
  ...
  const umkmItems = useMemo(() => {
    console.log(
      "FeaturedUMKMSection: Processing UMKM data, total items:",
      umkmData.length,
    );

    const items = umkmData
      .slice(0, 10)
      .map((umkm, index) => {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          >
            <span className="text-gray-900 dark:text-white">
              {t("featuredUmkm.title.prefix") || "UMKM"}{" "}
            </span>
          ...
          <div className="mb-4">
            <p
              className="text-xl md:text-2xl font-medium text-orange-600 dark:text-orange-400"
        ...
        <div className="mb-12">
          {(() => {
            console.log(
              "FeaturedUMKMSection: Rendering, umkmItems.length:",
              umkmItems.length,
            );
