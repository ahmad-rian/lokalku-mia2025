  ...
  const navItems = [
    {
      ...
      links: [
        {
          label: t("navbar.homeMenu.home"),
          href: "/",
          description: "Halaman utama",
        },
        {
          label: t("navbar.homeMenu.about"),
          href: "/about",
          description: "Tentang kami",
        },
        {
          label: t("navbar.homeMenu.featured"),
          href: "/#featured",
          description: "UMKM terpopuler",
        },
        {
          label: "Kontak",
    ...
    },
    {
      ...
      links: [
        {
          label: t("navbar.directoryMenu.explore"),
          href: "/direktori",
          description: "Jelajahi semua UMKM",
        },
        {
          label: t("navbar.directoryMenu.categories"),
          href: "/direktori/kategori",
          description: "Jelajah berdasarkan kategori",
        },
        {
          label: t("navbar.directoryMenu.latest"),
          href: "/direktori/terbaru",
          description: "UMKM yang baru terdaftar",
        },
      ],
    },
    {
      ...
      links: [
        {
          label: t("navbar.mapMenu.viewMap"),
          href: "/peta",
          description: "Peta interaktif UMKM",
        },
        {
          label: t("navbar.mapMenu.nearby"),
          href: "/peta/terdekat",
          description: "UMKM di sekitar Anda",
        },
      ],
    },
    {
      ...
      links: [
        {
          label: t("navbar.favoritesMenu.list"),
          href: "/favorit",
          description: "UMKM yang Anda simpan",
        },
      ],
    },
  ];
    ...
    <div className="fixed inset-x-0 top-0 z-[100] flex justify-center px-2 sm:px-4 pt-2 sm:pt-4">
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 h-[70px] flex items-center justify-between px-3 sm:px-6 z-10">
          {/* Left: Hamburger Menu Button + Mia Competitions */}
          ...
          {/* Center: Logo */}
          <RouterLink
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-2 sm:gap-3 group order-2"
            to="/"
          >
                    ...
                    {item.links.map((link) => {
                      return link.external ? (
                        ...
                        >
                          <ArrowUpRightIcon
                            aria-hidden="true"
                            className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0 group-hover:scale-110 transition-transform"
                          />
