...
export function InteractiveHoverButton({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-full bg-white scale-0 transition-transform duration-300 ease-in-out group-hover:scale-100 origin-left" />
      ...
      <div className="flex items-center gap-2 relative z-10 transition-all duration-300 ease-in-out group-hover:translate-x-12 group-hover:opacity-0">
        <div className="bg-current h-2 w-2 rounded-full" />
