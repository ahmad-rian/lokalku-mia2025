          ...
          <Button
            ...
            onPress={() => {
              if (umkm?.whatsapp) {
                ...
                window.open(
                  `https://wa.me/${umkm.whatsapp.replace("+", "")}?text=${encodeURIComponent(message)}`,
                  "_blank",
                );
              }
              onClose();
...
export default function DetailPage() {
  ...
  const handleShareToSocial = (platform: string) => {
    ...
    const text = encodeURIComponent(
      `Lihat ${umkm.name} - ${umkm.description.substring(0, 100)}...`,
    );
    ...
    switch (platform) {
      ...
      case "instagram":
        ...
        handleCopyLink();
        alert(
          "Link telah disalin! Buka Instagram dan paste link di story atau post Anda.",
        );
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              UMKM yang Anda cari tidak tersedia
            </p>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
                ...
                <div className="flex items-center gap-2 mt-4 text-sm text-gray-500 dark:text-gray-400">
                  <Clock size={16} />
                  <span>
                    {umkm.status === "open" ? "Tutup" : "Buka"} pukul{" "}
                    {umkm.nextStatusChange}
                  </span>
                </div>
              </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        {umkm.distance} dari lokasi Anda
                      </p>
                    </div>
                  </div>
