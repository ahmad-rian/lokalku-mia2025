      ...
      {images.map((img, idx) => {
        ...
        return (
          <div
            ...
            style={{
              animation: isVisible
                ? `fadeInUp 0.6s ease-out ${idx * 0.05}s both`
                : "none",
...
const MissionItem = memo(({ item }: { item: any }) => (
  <div className="flex gap-4 items-start p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:scale-[102%] cursor-pointer border border-gray-100 dark:border-gray-700">
    <div
      className={`flex-shrink-0 w-12 h-12 ${item.color === "orange" ? "bg-gradient-to-br from-orange-500 to-orange-600" : "bg-gradient-to-br from-primary-600 to-primary-700"} rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg`}
    >
      {item.num}
    </div>
    <div>
    ...
    return (
      <div ref={containerRef} className="flex flex-col gap-6">
        {childrenArray.slice(0, visibleCount).map((child, idx) => (
          <AnimatedListItem key={idx}>{child}</AnimatedListItem>
        ))}
      </div>
    );
  },
...
export default function About() {
  ...
  const umkmImages = useMemo(
    () => [
      {
        src: "https://images.unsplash.com/photo-1559925393-8be0ec4767c8?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Kedai Kopi Lokal",
        credit: "Sorin Gheorghita",
      },
      {
        src: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Warung Makan",
        credit: "Farhad Ibrahimzade",
      },
      {
        src: "https://images.unsplash.com/photo-1556740758-90de374c12ad?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Toko Retail",
        credit: "Mike Petrucci",
      },
      {
        src: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Butik Fashion",
        credit: "Clark Street",
      },
      {
        src: "https://images.unsplash.com/photo-1542744094-3a31f272c490?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Kedai Minuman",
        credit: "Nathan Dumlao",
      },
      {
        src: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Toko Kelontong",
        credit: "Austin Distel",
      },
      {
        src: "https://images.unsplash.com/photo-1556742111-a301076d9d18?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Restoran Kecil",
        credit: "Jay Wennington",
      },
      {
        src: "https://images.unsplash.com/photo-1556912172-45b7abe8b7e1?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Kafe Modern",
        credit: "Helena Lopes",
      },
      {
        src: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Bar & Resto",
        credit: "Jay Wennington",
      },
      {
        src: "https://images.unsplash.com/photo-1528698827591-e19ccd7bc23d?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Toko Bunga",
        credit: "Beata Ratuszniak",
      },
      {
        src: "https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Bakery Artisan",
        credit: "Nik Owens",
      },
      {
        src: "https://images.unsplash.com/photo-1546548970-71785318a17b?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Kedai Juice",
        credit: "Brooke Lark",
      },
      {
        src: "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Barbershop",
        credit: "Ksenia Chernaya",
      },
      {
        src: "https://images.unsplash.com/photo-1578643463396-0997cb5328c1?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Salon Kecantikan",
        credit: "Tamara Bellis",
      },
      {
        src: "https://images.unsplash.com/photo-1511688878353-3a2f5be94cd7?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Toko Buku",
        credit: "Kimberly Farmer",
      },
      {
        src: "https://images.unsplash.com/photo-1560440021-33f9b867899d?w=400&h=300&fit=crop&fm=webp&q=80",
        alt: "Craft Store",
        credit: "Annie Spratt",
      },
    ],
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left animate-blur-fade">
                ...
                >
                  ...
                  {language === "id" && (
                    <span
                      className="block text-2xl sm:text-3xl md:text-4xl font-medium text-orange-600 dark:text-orange-400"
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <ScrollReveal delay={0.2}>
                <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-2xl border border-blue-200 dark:border-blue-800 transform hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                    Terhubung dengan Jakarta, Yogyakarta, Surabaya, dan kota
                    besar Indonesia
                  </p>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.3}>
                <div className="p-6 bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-2xl border border-primary-200 dark:border-primary-800 transform hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                    Jangkauan internasional ke Singapura, Malaysia, dan negara
                    ASEAN
                  </p>
                </div>
              </ScrollReveal>
