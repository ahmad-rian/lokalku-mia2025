            ...
            <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-xl p-3 sm:p-4 shadow-xl border-2 border-gray-300 dark:border-gray-600">
              <div className="flex gap-2 mb-3">
                <Input
                  ...
                  classNames={{
                    input:
                      "bg-transparent text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400",
                    inputWrapper:
                      "bg-gray-50 dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 hover:border-primary-500 dark:hover:border-primary-400 data-[hover=true]:bg-gray-100 dark:data-[hover=true]:bg-gray-600",
                  }}
          ...
          <Dropdown>
            <DropdownTrigger>
              <Button
                ...
                variant="solid"
              >
                {mapTypes.find((type) => type.key === selectedMapType)?.label ||
                  "Peta"}
              </Button>
            </DropdownTrigger>
            <DropdownMenu
              ...
              <div className="space-y-4">
                ...
                <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                  <div className="flex gap-2">
                    ...
                    <div className="flex-1">
                      <h5 className="font-semibold text-sm text-blue-900 dark:text-blue-100 mb-1.5">
                        Tips Navigasi
                      </h5>
                      <ul className="text-xs text-blue-700 dark:text-blue-300 space-y-1">
                        <li className="flex items-start gap-1.5">
                          ...
                          <span>
                            Gunakan tombol <strong>kiri bawah</strong> untuk
                            ubah tampilan peta
                          </span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          ...
                          <span>
                            Aktifkan <strong>3D</strong> untuk perspektif tiga
                            dimensi
                          </span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          ...
                          <span>
                            Mode 3D: <strong>Shift+Drag</strong> untuk rotate,{" "}
                            <strong>Ctrl+Drag</strong> untuk tilt
                          </span>
                        </li>
                        <li className="flex items-start gap-1.5">
                          <span className="text-primary-600 dark:text-primary-400 font-bold">
